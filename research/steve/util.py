...
def tf_cheating_contcartpole(state, action):
    ...
    thetaacc = old_div((gravity * sintheta - costheta * temp),
                       (length * (old_div(4.0, 3.0) - masspole * costheta * costheta / total_mass)))
...
class ConfigDict(dict):
    def __init__(self, loc=None, ghost=False, **kwargs: _VT):
