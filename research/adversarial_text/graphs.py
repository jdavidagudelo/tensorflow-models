...
from . import adversarial_losses as adv_lib
  ...
  """
    ...
    def __init__(self, cl_logits_input_dim=None):
        ...
        self.layers = {'embedding': layers_lib.Embedding(
            ...
            self.vocab_freqs, FLAGS.keep_prob_emb), 'lstm': layers_lib.LSTM(
            FLAGS.rnn_cell_size, FLAGS.rnn_num_layers, FLAGS.keep_prob_lstm_out), 'lm_loss': layers_lib.SoftmaxLoss(
            FLAGS.vocab_size,
