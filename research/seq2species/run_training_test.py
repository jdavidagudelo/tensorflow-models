...
from research.seq2species import run_training
from research.seq2species.protos import seq2label_pb2
from research.seq2species import test_utils
...
class RunTrainingTest(parameterized.TestCase):
    ...
    def test_write_measures(self):
        ...
        tmp_path = os.path.join('/tmp', 'measures.pbtxt')
    ...
    """
        ...
        logdir = os.path.join('/tmp', 'train:{}'.format(len(targets)))
