...
from research.gan.cifar import util
...
flags.DEFINE_integer(
    ...
    'Number of threads to use for inter-op parallelism. If left as default value of 0, the system will pick an '
    'appropriate number.')

flags.DEFINE_integer(
    'intra_op_parallelism_threads', 0,
    'Number of threads to use for intra-op parallelism. If left as default value of 0, the system will pick an '
    'appropriate number.')
