...
def load_intrinsics(unused_frame_idx, cy):
    """Load intrinsics."""
...
class Bike(object):
    ...
    def load_image_sequence(self, target_index):
        ...
        start_index, end_index = get_seq_start_end(target_index,
                                                   ...
                                                   self.sample_every)
        image_seq = []
        zoom_x, zoom_y, cy = None, None, None
    ...
    def load_example(self, target_index):
        ...
        intrinsics = load_intrinsics(target_index, cy)
        intrinsics = self.scale_intrinsics(intrinsics, zoom_x, zoom_y)
        example = {'intrinsics': intrinsics, 'image_seq': image_seq, 'folder_name': target_video,
                   'file_name': target_filename.split('.')[0]}
        return example
