...
from research.tcn.preprocessing import cv2resizeminedge
from research.tcn.preprocessing import cv2rotateimage
from research.tcn.preprocessing import shapestring
from research.tcn.utils.progress import Progress
...
def bytes_feature(v):
    return feature(bytes_list=tf.train.BytesList(value=v))


def int64_feature(v):
    return feature(int64_list=tf.train.Int64List(value=v))


def float_feature(v):
    return feature(float_list=tf.train.FloatList(value=v))
