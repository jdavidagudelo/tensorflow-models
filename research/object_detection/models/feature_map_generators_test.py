...
class MultiResolutionFeatureMapGeneratorTest(tf.test.TestCase):
    ...
    def test_get_expected_variable_names_with_inception_v2(self, use_keras):
        ...
        expected_slim_variables = {'Mixed_5c_1_Conv2d_3_1x1_256/weights', 'Mixed_5c_1_Conv2d_3_1x1_256/biases',
                                   'Mixed_5c_2_Conv2d_3_3x3_s2_512/weights', 'Mixed_5c_2_Conv2d_3_3x3_s2_512/biases',
                                   'Mixed_5c_1_Conv2d_4_1x1_128/weights', 'Mixed_5c_1_Conv2d_4_1x1_128/biases',
                                   'Mixed_5c_2_Conv2d_4_3x3_s2_256/weights', 'Mixed_5c_2_Conv2d_4_3x3_s2_256/biases',
                                   'Mixed_5c_1_Conv2d_5_1x1_128/weights', 'Mixed_5c_1_Conv2d_5_1x1_128/biases',
                                   'Mixed_5c_2_Conv2d_5_3x3_s2_256/weights', 'Mixed_5c_2_Conv2d_5_3x3_s2_256/biases'}
...
class PoolingPyramidFeatureMapGeneratorTest(tf.test.TestCase):
    ...
    def test_get_expected_variable_names(self, replace_pool_with_conv):
        ...
        expected_pool_variables = set(expected_pool_variables)
        ...
        expected_conv_variables = set(expected_conv_variables)
