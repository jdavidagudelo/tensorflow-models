...
from research.object_detection.models import ssd_mobilenet_v2_keras_feature_extractor
...
class SsdMobilenetV2FeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):
    ...
    def test_extract_features_returns_correct_shapes_299(self, use_keras):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 18, 18, 576), (2, 9, 9, 1280),
                                      (2, 5, 5, 512), (2, 3, 3, 256),
                                      (2, 2, 2, 256), (2, 1, 1, 128)]
        self.check_extract_features_returns_correct_shape(
            2, image_height, image_width, depth_multiplier, pad_to_multiple,
    ...
    def test_extract_features_returns_correct_shapes_enforcing_min_depth(
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 18, 18, 192), (2, 10, 10, 32),
                                      (2, 5, 5, 32), (2, 3, 3, 32),
                                      (2, 2, 2, 32), (2, 1, 1, 32)]
        self.check_extract_features_returns_correct_shape(
            2, image_height, image_width, depth_multiplier, pad_to_multiple,
