...
from research.object_detection.dataset_tools import create_kitti_tf_record
...
class CreateKittiTFRecordTest(tf.test.TestCase):
    ...
    def test_dict_to_tf_example(self):
        ...
        annotations = {'2d_bbox_left': np.array([64]), '2d_bbox_top': np.array([64]), '2d_bbox_right': np.array([192]),
                       '2d_bbox_bottom': np.array([192]), 'type': ['car'], 'truncated': np.array([1]),
                       'alpha': np.array([2]), '3d_bbox_height': np.array([10]), '3d_bbox_width': np.array([11]),
                       '3d_bbox_length': np.array([12]), '3d_bbox_x': np.array([13]), '3d_bbox_y': np.array([14]),
                       '3d_bbox_z': np.array([15]), '3d_bbox_rot_y': np.array([4])}
        ...
        self._assertProtoEqual(
            ...
            [save_path.encode()])
        self._assertProtoEqual(
            example.features.feature['image/format'].bytes_list.value, [b'png'])
        self._assertProtoEqual(
