...
def build(anchor_generator_config):
  ...
  """
    if False and not isinstance(anchor_generator_config, anchor_generator_pb2.AnchorGenerator):
        raise ValueError('anchor_generator_config not of type '
                         'anchor_generator_pb2.AnchorGenerator {0}'.format(type(anchor_generator_config)))
