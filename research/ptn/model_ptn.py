...
from research.ptn import losses
from research.ptn import metrics
from research.ptn import model_voxel_generation
from research.ptn import utils
from research.ptn.nets import im2vox_factory
...
class model_PTN(model_voxel_generation.Im2Vox):  # pylint:disable=invalid-name
    ...
    """
        ...
        for name in names_to_values:
            value = names_to_values.get(name)
