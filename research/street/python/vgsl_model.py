...
from research.street.python import decoder
from research.street.python import errorcounter as ec
from research.street.python import shapes
import tensorflow as tf
from research.street.python import vgsl_input
from research.street.python import vgslspecs
...
def _ParseOutputSpec(output_spec):
  ...
  Raises:
    ValueError: if syntax is incorrect.
  """
    pattern = re.compile(R'(O)([012])([lsc])(\d+)')
