...
from research.slim.datasets import dataset_factory
from research.slim.deployment import model_deploy
from research.slim.nets import nets_factory
from research.slim.preprocessing import preprocessing_factory
        ...
        def clone_fn(batch_queue):
            ...
            if 'AuxLogits' in end_points:
                slim.losses.softmax_cross_entropy(
                    ...
                    scope='aux_loss')
            slim.losses.softmax_cross_entropy(
                logits, ls, label_smoothing=FLAGS.label_smoothing, weights=1.0)
            return end_points
